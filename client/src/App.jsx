...
import PaymentSuccessPage from "./pages/auth/secondaryUser/payment-success";
import PaymentFailPage from "./pages/auth/secondaryUser/payment-failure";
import PurchaseHistoryPage from "./pages/auth/secondaryUser/purchase-history";
